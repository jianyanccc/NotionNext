...
const BLOG = {
  ...
  AUTHOR: '沉默寡言的简言', // 作者
  BIO: '一个普通的大学生，喜欢自己动手的电子人', // 作者简介
  LINK: 'https://jianyan.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '1419587007@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/30022552?spm_id_from=333.1007.0.0', // B站主页
